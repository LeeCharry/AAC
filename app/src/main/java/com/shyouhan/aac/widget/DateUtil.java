...
public final class DateUtil {
    ...
    /** yyyy-MM-dd HH:mm */
    public static final ThreadLocal<SimpleDateFormat> defaultFormatDateTime = new ThreadLocal<SimpleDateFormat>() {

        @Override
        protected SimpleDateFormat initialValue() {
            return new SimpleDateFormat(DEFAULT_FORMAT_DATE_TIME);
        }
    ...
    public static String getDateFromMillis2(long timeInMillis) {
        return getDateFormat2(new Date(timeInMillis));
    }
    ...
    public static String getDate(Long time) {
        return new SimpleDateFormat("MM月dd日").format(new Date(time*1000L));
    }
    /**
     * MM月dd日 HH:mm
     * @param time
    ...
    public static String getDate3(Long time) {
        return new SimpleDateFormat("MM月dd日 HH:mm").format(new Date(time*1000L));
    }
    /**
     * yyyy-MM-dd HH:mm
     * @param time
    ...
    public static String getTime(Long time) {
        return new SimpleDateFormat("mm:ss").format(new Date(time*1000L));
    }
    ...
    public static String getDateFormat2(Date date) {
        return dateSimpleFormat(date, defaultFormatDateTime.get());
    }
    /**
     * ���HH:mm:ss��ʱ��
     * @param date
