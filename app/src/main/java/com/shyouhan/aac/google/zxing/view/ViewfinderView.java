...
package com.shyouhan.aac.google.zxing.view;
...
//    laserColor = array.getColor(R.styleable.ViewfinderView_laser_color, 0x00FF00);
    laserColor = array.getColor(R.styleable.ViewfinderView_laser_color, 0xE9BA59);
//    cornerColor = array.getColor(R.styleable.ViewfinderView_corner_color, 0x00FF00);
    cornerColor = array.getColor(R.styleable.ViewfinderView_corner_color, 0xE9BA59);
//    frameColor = array.getColor(R.styleable.ViewfinderView_frame_color, 0xFFFFFF);
    frameColor = array.getColor(R.styleable.ViewfinderView_frame_color, 0xBEBEBE);
...
//      canvas.drawText(labelText, frame.left + frame.width() / 2, frame.top - CORNER_RECT_HEIGHT, paint);
//      canvas.drawText(labelText, frame.left + frame.width() / 2, frame.top + frame.height() +100, paint);
